...
[![Docker Repository on Quay.io](https://quay.io/repository/ppavlov/docker-elasticsearch/status "Docker Repository on Quay.io")](https://quay.io/repository/ppavlov/docker-elasticsearch)
...
docker run --name elasticsearch \
	...
	--volume /path/to/data_folder:/data \
        quay.io/ppavlov/docker-elasticsearch:latest
```
...
docker run --name elasticsearch \
	...
	-e NODE_DATA=false \
        quay.io/ppavlov/docker-elasticsearch:latest
```
I also make available special images and instructions for [AWS EC2](https://github.com/ppavlov/elasticsearch-aws) and [Kubernetes](https://github.com/ppavlov/elasticsearch-kubernetes).
