...
[![Docker Repository on Quay.io](https://quay.io/repository/pires/docker-elasticsearch/status "Docker Repository on Quay.io")](https://quay.io/repository/ppavlov/docker-elasticsearch)
...
docker run --name elasticsearch \
	...
	--volume /path/to/data_folder:/data \
        quay.io/ppavlov/docker-elasticsearch:6.2.2
```
